function results = runProjectTests_SiL()
% This script is to automate the tests contained in this project
% input 'level' should be a character variable stating whether this test is
% 'mil' or 'sil'

% List names of all test files
    testsName = {'BMS_Tests_SiL'};
    level = 'sil';
    results = [];
...
% Removed older shared utils to allow for clean codegen and mex/exe generation
    scrubSharedUtils
